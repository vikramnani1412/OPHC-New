...
public class DoctorListnersImplementationClass implements ITestListener {
        ...
        if (report == null) {
            synchronized (AdminListnersImplementationClass.class) {
                if (report == null) {
                    ...
                    report.setSystemInfo("Base URL's", "https://stg-doctor.ophc.in/auth/login");
    ...
    public void onTestFailure(ITestResult result) {
        ...
        try {
            ...
            String path = new WebDriverUtility().takeScreenShot(DoctorBaseClass.sDriver, screenshotName);
