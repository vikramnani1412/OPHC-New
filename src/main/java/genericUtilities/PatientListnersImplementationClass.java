...
public class PatientListnersImplementationClass implements ITestListener {
        ...
        if (report == null) {
            synchronized (AdminListnersImplementationClass.class) {
                if (report == null) {
                    ...
                    report.setSystemInfo("Base URL's", "https://stg-patient.ophc.in/auth/login");
    ...
    public void onTestFailure(ITestResult result) {
        ...
        try {
            ...
            String path = new WebDriverUtility().takeScreenShot(PatientBaseClass.sDriver, screenshotName);
